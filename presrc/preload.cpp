...
const std::string DEFAULT_SYSTEM = "/system";
const std::string DEFAULT_DATA = "/data";
const std::string DEFAULT_FIRMWARE = "/firmware";
const std::string DEFAULT_VEN_FIRMWARE = "/vendor/firmware";
const std::string DEFAULT_NAME = "/dev/block/bootdevice/by-name";
...
redirect_writable_path (std::string const& pathname, std::string const& basepath)
{
    ...
    std::cerr << "snapcraft-preload: path '" << redirected_pathname << "'\n";
